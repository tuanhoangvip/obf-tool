...
░ ░ ░ ▒   ░    ░  ▒ ░░  ░  ░   ▒ ░ ░ ░  ░  ▒ ░  ░   ▒      ░   ░ ░ 
    ░ ░   ░       ░        ░   ░     ░     ░        ░  ░         ░ 
               ░                   ░                               
                  L-A-V-I-O-B-I-S-I-D-I-A-N
             ZALO GROUP:https://zalo.me/g/rcryht808
                LAVI OBF MADE BY NGÔ QUỐC HEO
"""
...
def stage(text: str, symbol: str = 'LAVIOBF', col1 = light, col2 = None) -> str:
    if col2 is None:
        col2 = light if symbol == 'LAVIOBF' else purple
...
author = f"""
((
    ((([["OBF ENCODE ĐƯỢC TẠO BỞI NGÔ QUỐC HEO VÀ NGÔ QUỐC MẠNH"],
    [" BOX ZALO : https://zalo.me/g/rcryht808"],
    ["PYTHON"],
    {{
    '__OBF_': 'LAVIOBF SUPREME PROTECTION',
    '__ADMIN_': 'NgoQuocHeoCoder',
    '__BANNER_': 'laviobf_python_protected',
    '__CONTACT_': 'https://zalo.me/g/rcryht808',
    '__FACEBOOK_': 'https://www.facebook.com/profile.php?id=61584942824419',
    '__ENG__': "LAVIOBF Supreme Protection by NgoQuocHeoCoder - Ultimate code protection against theft, cracking, and reverse engineering.",
    '__VN__': "LAVIOBF Bảo vệ tối thượng bởi NgoQuocHeoCoder - Bảo vệ code tuyệt đối chống đánh cắp, crack và phân tích ngược."
    }},
...
"""
open("obf-LAVI-" + _file, "w", encoding="utf8").write(str(code))
print(" Save in ", "obf-LAVI-" + _file)