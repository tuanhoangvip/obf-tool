...
"██║ ╚████║   ██║   ██║  ██║╚██████╔╝██║  ██║██║ ╚████║╚██████╔╝",
"╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ "       
\033[96mTool by Hoangdevxcoder\033[0m")
\033[92mNhóm Zalo Support:\033[0m \033[93mhttps://zalo.me/g/rcryht808\033[0m
\033[96mINBOX Admin để được hỗ trợ zalo:0931121950\033[0m")
''')
...
def Delay(value):
	...
	while not(value <= 1):
		...
		print(f'''{trang}[{lam}YUUYAKE{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [{vang}X    {trang}]''', '               ', end = '\r')
